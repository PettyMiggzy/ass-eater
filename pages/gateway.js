...
export default function Gateway() {
  ...
  return (
    <>
      <Head>
        <title>OnlyOne</title>
        <meta name="description" content="OnlyOne — an 18+ creator platform and token. Adult content, entry by age verification only." />
      ...
      <div className="min-h-screen bg-gradient-luxury text-white flex items-center justify-center px-6">
        <div className="max-w-md w-full premium-card p-8 text-center">
          ...
          <p className="text-gray-400 text-sm mb-8">
            OnlyOne is an adult creator platform. You must be 18 or older to enter. You'll be
