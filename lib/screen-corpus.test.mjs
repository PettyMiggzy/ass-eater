...
add('pass', FREE_TEXT, ['Mom of 3 kids. Nudes 20', 'No kids - porn only',
  'Mom of 2 kids - nudes & videos', 'Mom of 3 kids\nNudes 20 | videos 30', 'night night kids xxx', 'baby nudes 20 tonight']);
// Round 22 (decided child-safety principle): a child lead and a sexual or
// commerce word ANYWHERE in the text is refused, whichever sentence each is
// in. This row passed from round 20 to round 21 (a sentence break separated
// the two); it contains both signals, so it moved to refuse. A count ("Mom
// of 3 kids") and a negation ("No kids") are not child leads.
add('refuse', FULL, ['Busy with the kids. Sex tapes drop friday']);
...
// ---------------------------------------------------------------------------
// ROUND 22 (accounts#0-#9): every string the audit named, both directions.
// accounts#0: a determiner or an age word after "daddy/mommy/mom of|to" is
// never a count of children.
add('refuse', FULL, ['Daddy to my 13 year old slut', 'mommy of a 12 year old slut', 'Daddy to a 13yo babe', 'Daddy of 14 and horny',
  'Papa to my 16 yo slut 😈', 'mom of a 13 year old girl who sells nudes', 'parents of a 12 year old porn star', 'Mom to a 14 yo and horny',
  'daddy to my 9 year old slut', 'daddy of a 7yo girl nudes'], { kind: 'prohibited' });
add('pass', FREE_TEXT, ['Mom of 2 and horny', 'mom of 3 and horny', 'Mom of 13 and horny', 'Single mom of 2 and a slut for attention']);
// accounts#1: the sale one sentence later.
add('refuse', FULL, ['my daughter just turned 13. wanna see her body?', 'My daughter just turned 13! Pics of her for sale',
  'our 13 year old daughter. pics $20', 'my 12 year old daughter! dm for her pics', "She's 7. Nudes $20", 'she just turned 8. her pics for sale',
  'Just turned 5! pics for sale dm', 'my daughter is 13, nudes for sale', 'my daughter is 13 - nudes for sale', 'My daughter is 12. Her nudes $20',
  'My daughter turned 13 today. Want to fuck her?'], { kind: 'prohibited' });
add('pass', FREE_TEXT, ['My daughter just turned 5!', 'our son is 13 today', 'my 3 year old boy is sick']);
// accounts#2: advocacy nouns only behind an advocacy lead, free text only.
add('refuse', ALL, ['child sex slaves for sale', 'kids sex workers for hire', 'child sex trade vids $20', 'child sex rings dm me for links',
  'kid sex slave videos']);
add('refuse', STRICT, ['child sex slaves', 'fighting child sex slavery']);
add('pass', FREE_TEXT, ['fighting child sex slavery', 'Stop child sex tourism', 'End child sex trade now', 'Survivor of child sex abuse']);
// accounts#3: any label separator between the school and the person word.
add('refuse', FULL, ['Highschool: girl nudes $20', 'High school | girl nudes', 'high school / girls naked', 'High School • Girl Nudes',
  'high school, girl nudes', 'middle school: boy porn', 'School - girl nudes', 'school, girl nudes', 'school | girl porn']);
add('pass', FREE_TEXT, ['In high school, boys never noticed me', 'Graduated high school - girls trip to Cancun!']);
// accounts#4/#5: under-ten ages with the "and" tail, and glued.
add('refuse', FULL, ['my niece is 9 and horny', 'hot 9 and horny', 'Hi, 9 and horny', 'she is 9 and a virgin', "he's 7 and a virgin", "she's 8, horny",
  'she just turned 9, dm for pics', "i'm 9 and wet", 'im 8 and sexy', "I'm 8 and naughty", "she's 8 and wants cock", "i'm 9 and love cock",
  '9 years old and horny', '9 yo and horny', '8 year old and sexy', 'nine and horny']);
add('refuse', STRICT, ['9andhorny', 'jess9andhorny', 'sevenandhorny', '9andwet', '8andnaked', '9nhorny', '9 and wet', 'seven and horny']);
add('pass', FREE_TEXT, ['Round 2 and horny', 'size 8 and sexy', '24/7 and horny', 'Nudes 5 & wet pussy 9']);
// accounts#6: reverse pairs, "with", the acronyms and the younger schools.
add('refuse', FULL, ['nude kids', 'naked children', 'nude children for sale', 'naked kids pics', 'sex with kids', 'sex with minors', 'fuck a kid',
  'porn with kids', 'csam for sale', 'selling csam', 'csam links', 'child sexual abuse material for sale', 'prepubescent porn',
  'pre-pubescent nudes', 'kiddo porn', 'kiddos nudes', 'lil girl nudes', 'kindergarten porn', 'elementary school porn',
  'grade schooler nudes', 'Naked kids pics', 'CSAM for sale', 'Prepubescent girl set', 'cp for sale', 'selling cp'], { kind: 'prohibited' });
add('refuse', NAME, ['nakedkids', 'lilgirl', 'csam4sale']);
add('pass', FREE_TEXT, ['We report CSAM to NCMEC', 'No sex with minors ever', 'CP 12 is the checkpoint', 'my cp score went up']);
// Round 22: both auditor-suggested "pass" rows below contain a child lead AND
// a sexual word, so the decided principle refuses them (the accepted cost).
add('refuse', FREE_TEXT, ['Sex with kids in the house is impossible lol', 'my fucking kids woke me up']);
// accounts#7: a parent's "my little girl".
add('pass', FREE_TEXT, ['My little girl just turned 5!', 'Happy birthday to my little girl', 'My little girl starts school tomorrow',
  'Sorry late reply, my little girl was sick', 'my little boy is sick today', 'Mommy of a little boy', 'our lil girl lost a tooth']);
add('refuse', ALL, ["daddy's little girl", 'your little girl', 'little girl nudes']);
add('refuse', FREE_TEXT, ['my little girl is so horny', 'my little girl, pics $20']);
// accounts#8: item counts in listing copy.
add('pass', FREE_TEXT, ['Includes 12 nudes and 3 videos', 'You get 15 nudes and 2 clips', 'Includes 12 nudes, 3 videos', '15 Nudes + 2 Videos',
  '12 nudes & 3 vids', 'Set of 10 nudes', 'Pack of 15 nudes', 'Bundle of 12 nudes', 'Total of 14 nudes', 'Pack of 10 sexy nudes',
  'Unlock 15 nudes', 'x12 nudes']);
add('refuse', FREE_TEXT, ['Set of 16 year old nudes', 'my daughter is 12. Includes 12 nudes and 3 videos']);
// accounts#9: tg.
add('refuse', FULL, ['pay me on tg babe', 'pay me on tg girl', 'pay $20 on tg bundle', 'cheaper on my tg content'], { pay: true });
add('pass', FREE_TEXT, ['TG $20', 'TG $20 today only', 'Hot TG $20', 'TG $15 each', 'TG: $20', 'TG, $20 for customs']);
