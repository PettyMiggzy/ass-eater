 ...
 *     with an ID attached or held offline. Stored on the item.
 *
...
export async function resolvePerformerAttestation(body, { admin = false } = {}) {
  ...
  const { rows } = await query(
    `select id::text as id from performer_records
