...
const DISCLAIMER_BEFORE_RE = new RegExp(
  "(?:^|[^a-z])(?:no|not|never|nobody|no ?one|none|zero|dni|are (?:you|u)|r u|if (?:you ?(?:'?re|are)|youre|ur|u r|u are))"
  + '(?:[^a-z0-9]{1,3}(?:one|body|person|people|minors?|kids?|or|and|&|\\/)){0,2}[^a-z0-9]{0,3}$',
);
// After the term, three shapes count, and only these (round-10 fix-up: a bare
...
function detectIn(normalized, add) {
