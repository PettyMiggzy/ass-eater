...
const MINOR_LONG_AGE = '[\\s-]{0,2}(?:yrs?[\\s-]{0,2}old|years?[\\s-]{0,2}old)(?![a-z])' + NOT_A_DRINK;
...
const PERSON_LEAD = '(?<![a-z])(?:' + PERSON_ADJ + '|' + SEXUAL_NOUN + '|' + SEXUAL_VERB + ')[\\s-]{1,2}';
...
const PERSON_AFTER_LONG = '(?:' + CLAUSE_END + '|' + NOUN_WITHIN_TWO + ')';
...
const MINOR_AGE_RES = [
  ...
  new RegExp(MINOR_AGE_NUM + MINOR_ANY_AGE + '[\\s-]{1,2}' + PERSON_OR_SEXUAL_NOUN + '(?![a-z])'),
];
