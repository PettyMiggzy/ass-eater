...
section('accounts#0/#1: cross-tag screening');
{
  ...
  for (const [tags, kind] of [[['school', 'girl'], 'prohibited'], [['barely', 'legal'], 'prohibited'], [['#school.', 'girl'], 'prohibited'], [['cash', 'app jane'], 'payment'], [['text me', '555 123 4567'], 'payment'], [['snapchat', '@jane99'], 'payment'], [['telegram', 'janedoe99'], 'payment'], [['snapchat', 'jane_doe'], 'payment'], [['insta', 'janedoe_99'], 'payment'], [['#telegram', '#janedoe99'], 'payment'], [['cash', 'app'], 'payment']]) {
