...
const BRIDGE_CUE = '(?:\\$\\d[0-9,.]*|(?<![a-z0-9])(?:pay|payment|payments|cheaper(?![a-z0-9])(?!\\s+than(?![a-z0-9])))(?![a-z0-9]))';
const CLAUSE_SEP = '[^a-z0-9$.!?,;|\\n]{1,3}';
const CUE_BRIDGE_BEFORE_RAIL_RE = new RegExp(`${BRIDGE_CUE}(?:${CLAUSE_SEP}[a-z0-9']{1,15}){1,5}${CLAUSE_SEP}$`);
