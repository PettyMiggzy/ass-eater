...
// "text me 6175551234".
const PHONE_CUE_RE = /(?<![a-z0-9])(?:call|text|txt|whatsapp|whats ?app|sms|imessage|hmu|phone|cell|cellphone|mobile|signal|facetime|skype|telegram|my (?:number|digits|line))(?![a-z0-9])/;
...
const PHONE_AMBIGUOUS_RE = /(?<![\d\-.$])(?:\d{3}\s\d{3}\s\d{4}|\d{3}[\s.\-/]\d{3}[\s.\-/]\d{4}|\+?\d{7,15})(?![\d\-])/g;
