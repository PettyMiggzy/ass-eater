...
// its URL path.
const OFF_PLATFORM_LINK_RE = /(?<![a-z0-9])(?:beacons\.ai|bio\.link|lnk\.bio|throne\.com|linktr\.ee|allmylinks\.com|fanvue\.com|manyvids\.com|ko[\s._-]fi|amazon\.[a-z.]{2,7}\/(?:[a-z-]{2,5}\/)?(?:hz\/)?wishlist)(?![a-z0-9])/;
