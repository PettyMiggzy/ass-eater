...
// the real test; the message regex stays as a secondary check in case a
// bundler or a duplicated copy of the package breaks instanceof identity.
function isNotFound(err) {
  return err instanceof BlobNotFoundError || /does not exist|not found/i.test(String(err?.message || ''));
}
