 ...
 *
 * Source of truth is PlatformConfig.vipPriceCents in server/, which isn't
 * deployed. This mirror exists so the live site's copy has one number to
 * quote instead of a literal typed into each page.
 */
