 ...
 */
export function mintBridgeToken(user, creatorStatus = null, { fanStanding = null, standingAt = Date.now() } = {}) {
  ...
  const payload = {
    ...
    creatorStatus: isCreator ? (CREATOR_STATUSES.has(creatorStatus) ? creatorStatus : 'banned') : null,
    ...
    ...(isCreator ? {} : { standing: FAN_STANDINGS.has(fanStanding ?? 'active') ? (fanStanding ?? 'active') : 'banned' }),
