...
try {
  ...
  section('Possible-minor report bans outright, paid files included (review: minor ban)');
  {
    ...
    const r2 = await call(resolveRoute, { admin: true, body: { id: self.id, action: 'removed', creatorId: 'm2' } });
    ...
    const r4 = await call(resolveRoute, { admin: true, body: { id: minor3.id, action: 'removed' } });
