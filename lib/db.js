...
-- sweep in lib/media.js (sweepOrphanedMedia) takes rows older than an hour,
-- deletes the file if no creator or listing record references it, and drops
-- the row. Nothing else lists the store, so this is the only record that such
