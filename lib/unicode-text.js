...
// block. Nobody types them into a message, a comment or a report, and JSON
// writes each one as a 6-byte "\u00XX" escape -- the cheapest way to inflate
// what an admin has to load (round-12 social#0 for the NCII queue, round-13
// social#0 for DMs and wall comments). Refused, not stripped: stripping would
// silently change what someone submitted.
