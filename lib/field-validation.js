...
/**
 * A public name that is nothing but a phone number: digits and the
 * punctuation phone numbers are written with, at least 7 digits. One rule for
...
export function looksLikePhoneNumber(value) {
  ...
  return /^[\d.\-_ ()+]{7,}$/.test(s) && (s.match(/\d/g) || []).length >= 7;
}
