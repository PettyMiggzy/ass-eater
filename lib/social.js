 ...
 *
 * `description` says "up to 90%" on purpose: the platform fee is 10%, but
 * marketplace sales carry an extra 5% listing fee (lib/fees.js), so a flat
 * "keep 90%" is false for the one thing most creators sell.
 */
export function organizationJsonLd() {
  return {
    ...
    description:
      'A creator platform for women, men, couples and everyone. Creators keep up to 90% of what they earn. 18+ only.',
    email: CONTACT_EMAIL,
    logo: LOGO_IMAGE,
    image: OG_IMAGE,
