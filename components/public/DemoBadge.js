 ...
 * anyone mistaking a sample page for a real person they can pay.
 */
export default function DemoBadge({ className = '', short = false }) {
  return (
    <span
      title="A sample profile made by OnlyOne to show how the site works. Nothing here is for sale."
